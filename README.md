...
See also: <a href="https://en.wikipedia.org/wiki/Multinomial_distribution">Multinomial distribution</a> (e.g., it models the probability of counts for each side of a k≥2-sided die rolled n times)
